...
public class JwtErrorCodeUtil {
  ...
  private static final Map<Class<? extends Exception>, ErrorCode> ERROR_CODE_MAP =
      Map.of(
  ...
  public static ErrorCode determineErrorCode(Exception exception, ErrorCode defaultErrorCode) {
    if (exception instanceof JwtException jwtException) return jwtException.getErrorCode();
